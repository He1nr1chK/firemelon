...
function syncFireMelon(database, syncObj, db, sessionId, getTimestamp) {
    if (getTimestamp === void 0) { getTimestamp = function () { return new Date(); }; }
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        case 0:
                                            ...
                                            lastPulledAtTime = new Date(lastPulledAt || 0);
                                            changes = {};
                                                                                                        ...
                                                                                                        return __generator(this, function (_d) {
                                                                                                            switch (_d.label) {
                                                                                                                ...
                                                                                                                case 3:
                                                                                                                    ...
                                                                                                                    if ((deleted_at === null || deleted_at === void 0 ? void 0 : deleted_at.toDate()) > lastPulledAt) {
